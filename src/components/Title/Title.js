  ...
  return (
    <div className={style.info_conteiner}>
      ...
      <p className={style.description}>
        ...
        CSS3,JS,React,Redux. A conscientious, tactful and responsive person
        always strives for excellence in the business he is doing! Cheerful,
        friendly and always try to be positive.
      </p>
    </div>
  );
}
